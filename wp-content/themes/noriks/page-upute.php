<?php
/**
 * Template Name: Használati útmutatók
 *
...
<div class="nmn">
  <div class="nmn-wrap">
    ...
    <p class="nmn-sub">Töltse le NORIKS terméke útmutatóját PDF formátumban.</p>
    ...
    <div class="nmn-search">
      ...
      <input type="search" id="nmn-q" placeholder="Keresés terméknév alapján…" autocomplete="off">
    </div>
          ...
          <div class="nmn-body">
            ...
            <p class="nmn-links">
              <a class="nmn-btn" href="<?php echo esc_url( $dir_url . $m['file'] ); ?>" target="_blank" rel="noopener">
                PDF letöltése <span>(<?php echo esc_html( $size ); ?>)</span>
              </a>
              <?php if ( $p['url'] ) : ?>
                <a class="nmn-link" href="<?php echo esc_url( $p['url'] ); ?>">Termékoldal</a>
              <?php endif; ?>
            </p>
          </div>
        </div>
    ...
    <p class="nmn-empty" id="nmn-empty" hidden>Nincs útmutató erre a kifejezésre. Írjon nekünk: <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
    <p class="nmn-help">Segítségre van szüksége a termékhez? Írjon nekünk: <a href="mailto:info@noriks.com">info@noriks.com</a>.</p>
  </div>
</div>
