...
<nav class="category-menu">
  <ul>
    <li class="<?php echo is_shop() ? 'active' : ''; ?>">
      <a href="/hu/shop">Minden termék</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/polok') ? 'active' : ''; ?>">
      <a href="/hu/product-category/polok/">Pólók</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/boxerek') ? 'active' : ''; ?>">
      <a href="/hu/product-category/boxerek/">Boxerek</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/szettek') ? 'active' : ''; ?>">
      <a href="/hu/product-category/szettek/">Szettek</a>
    </li>

    <li class="<?php echo is_active_menu_item('/product-category/zoknik') ? 'active' : ''; ?>">
      <a href="/hu/product-category/zoknik/">Zoknik</a>
    </li>
  </ul>
</nav>
</section>
...
// CATEGORY GROUP (starter packs)
    ...
    is_product_category_or_child('legnepszerubb') ||
    is_product_category_or_child('nagy-csomagok') ||
    is_product_category_or_child('kezdocsomag') ||
