...
<form name="checkout" method="post" class="checkout woocommerce-checkout"
      action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data" aria-label="Fizetés">
    ...
    <div class="col-2">
      ...
      <div class="woocommerce-additional-fields">
              ...
              <label for="shipping_method_0_standard_custom" class="checkedlabel">
                ...
                <div class="outer-wrapper">
                  ...
                  <div class="inner-wrapper-img">
                    <span class="shipping_method_delivery_price tag tag--red"><?php $ship = (float) WC()->cart->get_shipping_total(); echo $ship > 0 ? wc_price($ship) : 'Ingyenes'; ?></span>
        ...
        <div id="hs-vat-tax-checkout-prompt">
          <span class="tax-and-vat-checkout-claims">Nincsenek további költségek a vámkezeléshez</span>
          <span class="tax-and-vat-checkout-claims">ÁFA benne van az árban</span>
        </div>
...
<div class="checkout-warranty flex flex--center flex--middle">
  ...
  <div class="flex__item--autosize f--m checkout-warranty__text">
    <strong>Vásároljon gondtalanul </strong><br>Pénzvisszafizetés 30 napon belül
  </div>
</div>
...
jQuery(function($){
  ...
  var days=['vasárnap','povasárnapk','kedd','szerda','csütörtök','péntek','szombat'];
