  ...
  <div class="checkout-coupon-inline">
    <p class="form-row cci-form-row-first">
      ...
      <input
        ...
        id="cci-coupon-input"
        class="input-text"
        placeholder="<?php esc_attr_e( 'Kedvezménykód vagy ajándékkártya', 'woocommerce' ); ?>"
      />
    </p>
...
(function($){
  ...
  function successHtml(){
    return '<div class="woocommerce-message" role="alert">Αίτημα κουπονιού.</div>';
  }
  function errorHtml(){
    return '<ul class="woocommerce-error" role="alert"><li>Kérjük, adjon meg érvényes kedvezménykódot vagy ajándékkártyát.</li></ul>';
  }
  ...
  $(ensureNoticeTarget);
        	...
        	<div id="order_review" class="woocommerce-checkout-review-order">
        	    ...
        	    <h3 class="checkout-section-title">Rendelés összegzése</h3>
                 ...
                 <div class="inline-coupon-notices dekstopni"></div>
                   ...
                   <script>
                    (function($){
                      ...
                      function errorHtml(){   return '<ul class="woocommerce-error" role="alert"><li>Kérjük, adjon meg érvényes kedvezménykódot vagy ajándékkártyát.</li></ul>'; }
