...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const eur = new Intl.NumberFormat('hu-HU', {
    style: 'currency',
    currency: 'EUR',
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/hu/shop">Állítsa össze a csomagját</a>
                        <a href="/hu/product-category/tricka/">Kész csomagok</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/hu/product-category/boxerky-sastavi-paket/">Állítsa össze a csomagját</a>
                        <a href="/hu/product-category/boxerky/">Kész csomagok</a>
                    </div>
                    -->
                </div>
    ...
    <div class="navbar-right">
      ...
      <div class="cart-auto-icon">
        ...
        <?php if ( class_exists( 'WooCommerce' ) ) : ?>
            <a class="header-cart" href="/hu/cart">
                <div class="cart-icon">
