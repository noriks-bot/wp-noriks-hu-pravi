	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			array(
				...
				'label'        => 'Upsell megjelenítése a gomb alatt (3x Kék boxer)',
				'name'         => 'noriks_pp_upsell',
				'type'         => 'true_false',
				'instructions' => 'Hozzáadja a "Vásárolja együtt és spóroljon" dobozt közvetlenül a Kosárba gomb alá. A vásárló méretet választ, 3 darab kerül hozzáadásra upsell áron. Csak erre a termékre vonatkozik.',
				'ui'           => 1,
			),
		),
		'location'   => array(
...
function noriks_pp_upsell_config() {
	return apply_filters( 'noriks_pp_upsell_config', array(
		...
		'total'      => 5370,                   // ista cijena kao thank you upsell (3 x 4,99)
		'title'      => '3x Kék boxer',
