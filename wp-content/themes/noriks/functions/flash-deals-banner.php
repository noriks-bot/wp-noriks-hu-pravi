...
const NORIKS_FLASH_CAT   = 'nyari-akcio';
...
function noriks_flash_deals_banner() {
    ...
    ?>
    <div class="nfd" role="region" aria-label="Nyári akció">
      <div class="nfd-in">
        <div class="nfd-left">
          <p class="nfd-eyebrow">Szezonális akció</p>
          <div class="nfd-head">
            <h2 class="nfd-title">Nyári akció</h2>
            <?php if ( $off > 0 ) : ?>
              <span class="nfd-badge">-&minus;<?php echo (int) $off; ?>%</span>
            <?php endif; ?>
          </div>
          <p class="nfd-sub">Amíg a készlet tart</p>
        </div>

        <div class="nfd-right">
          <span class="nfd-cta">Az ajánlat lejár</span>
          <div class="nfd-clock" id="nfd-clock" aria-live="off">
            <span class="nfd-unit"><b data-u="d">00</b><em>nap</em></span>
            <span class="nfd-unit"><b data-u="h">00</b><em>óra</em></span>
            <span class="nfd-unit"><b data-u="m">00</b><em>perc</em></span>
            <span class="nfd-unit"><b data-u="s">00</b><em>mp</em></span>
          </div>
        </div>
      </div>
    </div>
