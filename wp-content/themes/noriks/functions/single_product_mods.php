...
function my_add_price_to_button_text( $text, $prod = null ) {
    ...
    if ( has_term( array( 'startovaci-balicek','orto', 'paketo-ekkinisis', 'starter-pack' ), 'product_cat', $prod->get_id() ) ) {
        return $text;
    }
...
add_action( 'wp_footer', function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  if (!btn) return;
	  btn.textContent = 'Vissza a kiválasztáshoz';
...
function noriks_controlpro_atc_testimonial() {
    ...
    <div class="cpr-atc-rev">
        <img class="cpr-atc-avatar" src="<?php echo esc_url( $avatar ); ?>" alt="Elégedett NORIKS ControlPro vásárló" loading="lazy">
        <div class="cpr-atc-body">
            <p class="cpr-atc-text">„A prosztataműtét után két éven át rendszeresen végeztem Kegel-gyakorlatokat, és nem láttam érdemi javulást. Azt hittem, életem végéig betétet fogok hordani. Négy hét ezzel az eszközzel, és napi 5 betétről nullára jutottam."</p>
