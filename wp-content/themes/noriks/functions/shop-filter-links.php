...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			'legnepszerubb' => 'Legnépszerűbb',
			'kezdocsomag' => 'Kezdőcsomag',
			'nagy-csomagok' => 'Nagy csomagok',
		),
		'boxerek' => array(
			'boxeralsok-1-db' => '1 db',
			'boxeralsok-3-db-csomag' => '3 csomag',
			'boxeralsok-5-db-csomag' => '5 csomag',
			'boxeralsok-7-db-csomag' => '7 csomag',
			'boxeralsok-10-db-csomag' => '10 csomag',
			'boxeralsok-15-db-csomag' => '15 csomag',
			'boxeralsok-fekete' => 'Fekete',
			'boxeralsok-szines' => 'Színes',
		),
		'polok' => array(
			'polok-1-db' => '1 db',
			'polok-3-db-csomag' => '3 csomag',
			'polok-6-db-csomag' => '6 csomag',
			'polok-9-db-csomag' => '9 csomag',
			'polok-12-db-csomag' => '12 csomag',
			'polok-15-db-csomag' => '15 csomag',
			'polok-fekete' => 'Fekete',
			'polok-szines' => 'Színes',
		),
		'szettek' => array(
			'szett-2-polo-5-boxeralso' => 'Szett: 2+5',
			'szett-4-polo-10-boxeralso' => 'Szett: 4+10',
			'szett-5-polo-5-boxeralso' => 'Szett: 5+5',
		),
		'zoknik' => array(
			'zoknik-fekete' => 'Fekete',
			'zoknik-feher' => 'Fehér',
		)
	) );
}
