 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+36...),
 * ker je Metakocka del narocil zavracala samo zaradi presledkov in oklepajev.
 */

if ( ! defined( 'ABSPATH' ) ) { exit; }

define( 'NORIKS_TEL_CC',    '36' );
define( 'NORIKS_TEL_TRUNK', '06' );
...
add_action( 'woocommerce_checkout_process', function () {
    ...
    if ( $p !== '' && ! noriks_tel_ok( $p ) ) {
        wc_add_notice( 'Ellenőrizze a telefonszámot — úgy tűnik, nem teljes.', 'error' );
    }
}, 5 );
...
add_action( 'wp_footer', function () {
    ...
    jQuery(function($){
      var CC = '36', TRUNK = '06', MIN = 9, MAX = 11;
      var MSG = <?php echo wp_json_encode( 'Ellenőrizze a telefonszámot — úgy tűnik, nem teljes.' . ' ' . 'pl. 06 20 123 4567' ); ?>;
