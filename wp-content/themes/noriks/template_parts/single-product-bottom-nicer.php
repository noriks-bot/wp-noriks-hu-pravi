...
if ( has_term( array( 'bokserice', 'orto-bokserice', 'bokserice-sastavi-paket', 'boxerky', 'mpoxerakia', 'boxers', 'boxerakia' ), 'product_cat', get_the_ID() ) ) {
...
<section style="display:block; max-width:1440px; margin:0 auto; padding-bottom:30px;" class="most-popular">
    <div class="container" style="padding-left:10px; padding-right:10px;">
        <h2 class="section-title" style="margin-bottom:20px;">Kész kombinációk - egyszerű és gyors</h2>
                            ...
                            <?php
                                ...
                                if ($shirt_count != 1):
                                    if ($alt_output == false):
                                        ...
                                        if ($is_boxers):
                                            $topseler_text = get_field("singlepp_priceper_before","options") . " " . $tmp_price . " " . "€ boxeralsónként";
                                        else:
