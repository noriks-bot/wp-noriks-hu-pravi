 ...
 *   1. Kapja vissza a reggeleket, amelyeket már elveszettnek hitt   11_jutra
 ...
 *   7. Nem minden térdpárna egyforma                      05
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">A különbség, amit már az első éjjel érez</h2>
      <p><strong>Párna nélkül:</strong> a felső láb ráesik az alsóra, a medence elcsavarodik, a nyomás pedig a derékba és a térdekbe kerül.</p>
      <p><strong>A NORIKS Clouddal:</strong> a lábak a csípővel egy vonalban maradnak, a súly eloszlik, a nyomáspontok pedig eltűnnek.</p>
      <ul class="ncd-check">
        <li>Csípő és térd természetes vonalban</li>
        <li>Kevesebb nyomás a deréktájon</li>
        <li>Kevesebb forgolódás éjszaka</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Kezdjen jobban aludni már ma este</h2>
    <p class="ncd-sub">Egyszerű használat. <strong>Jobb alvás</strong> az első éjszakától.</p>
  </div>
  <div class="ncd-wrap">
      ...
      <?php foreach ( $cd_steps as $i => $st ) : ?>
        <div class="ncd-step4">
          <div class="ncd-step4-ic">
            ...
            <span class="ncd-step4-b">Lépés <?php echo (int) $i + 1; ?></span>
          </div>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Miért más az ébredés a NORIKS Clouddal</h2>
    <p class="ncd-sub ncd-rate"><span class="ncd-stars">★★★★★</span> Értékelés <strong>4,8/5</strong> ezer elégedett vásárló</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-revs">
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Oldalt alvás</p>
      <h2 class="ncd-h2">Kapja vissza a reggeleket, amelyeket már elveszettnek hitt</h2>
      <p>Ismeri az érzést: merev testtel ébred, egész éjjel keresi a fájdalommentes pozíciót, vagy többször felébred minden ok nélkül.</p>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Az a beállítás, amit reggel érez</h2>
      ...
      <ul class="ncd-check">
        <li>Egyenes gerinc a csavarodott helyett</li>
        <li>Egyenes medence csavarodás nélkül</li>
        <li>Szétválasztott térdek, nyomás nélkül</li>
      </ul>
    </div>
...
<?php
$cd_cases = array(
  array( 'cld-case-bok.webp',       'Oldalt alvás', 'Prilagođeno vašem prirodnom položaju.' ),
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-center">
    <h2 class="ncd-h2">Arra tervezve, ami megakadályozza az alvásban</h2>
    <p class="ncd-sub">Hat helyzet, ahol a térdpárna a legnagyobb különbséget hozza.</p>
  </div>
  <div class="ncd-wrap">
    <div class="ncd-cases">
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Úgy készült, hogy szellőzzön</h2>
      <p>Orvosi minőségű memóriahab beépített perforációval — elég szilárd, hogy tartsa a távolságot, elég puha, hogy alkalmazkodjon a testhez.</p>
      <ul class="ncd-check">
        <li><strong>Mosható huzat</strong> — szellőző anyag, kíméletes a bőrhöz</li>
        <li><strong>A perforációk</strong> egész éjjel frissen tartják a habot</li>
        <li><strong>Megtartja a formáját</strong> évekig, nem lapul le</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    ...
    <div class="ncd-copy">
      <h2 class="ncd-h2">Nem minden térdpárna egyforma</h2>
      <ul class="ncd-vs">
        <li class="is-no"><strong>Pánt nélkül</strong><span>kiesik, amint megfordul</span></li>
        <li class="is-no"><strong>A középső lyuk</strong><span>akadályozza a keringést</span></li>
        <li class="is-no"><strong>Lelapul</strong><span>néhány hét alatt</span></li>
        <li class="is-yes"><strong>Állítható pánt</strong><span>pontosan a helyén marad</span></li>
        <li class="is-yes"><strong>Tömör, ergonomikus forma</strong><span>lyukak és üregek nélkül</span></li>
        <li class="is-yes"><strong>Orvosi minőségű hab</strong><span>évekig tartja a formáját</span></li>
      </ul>
    </div>
  </div>
</section>
...
<section class="ncd-sec ncd-dark">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <h2 class="ncd-h2">Szigorú szabványok szerint készült</h2>
      <p>Az anyagokat káros anyagokra tesztelték, a hab pedig tanúsított. A dizájn svájci minőségi szabványok szerint készült.</p>
      <ul class="ncd-check">
        <li><strong>OEKO-TEX® STANDARD 100</strong> — káros anyagoktól mentes</li>
        <li><strong>CertiPUR-EU</strong> — tanúsított memóriahab</li>
        <li><strong>Svájcban tervezve</strong>, európai szabványok szerint gyártva</li>
      </ul>
    </div>
...
<section class="ncd-sec">
  <div class="ncd-wrap ncd-row2">
    <div class="ncd-copy">
      <p class="ncd-eyebrow">Kockázat nélkül</p>
      <h2 class="ncd-h2">60 éjszaka kipróbálás</h2>
      <p>Próbálja ki maga. Ha a NORIKS Cloud nem való Önnek, a teljes összeget visszatérítjük — feltételek és papírmunka nélkül.</p>
      <a class="ncd-cta" href="#bundle-selector">NORIKS Cloud rendelése</a>
    </div>
    <div class="ncd-media"><?php echo $cd_img('cld-60-noci.webp','60 éjszaka kipróbálás'); ?></div>
  </div>
</section>
