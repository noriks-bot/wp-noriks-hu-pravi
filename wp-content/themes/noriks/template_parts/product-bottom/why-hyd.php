...
$nhy_marquee = array(
  ...
  array( 'beskraj', 'Tartós szűrő, bez zamjena' ),
...
<!-- ============ 2) Nézze, hogyan pezseg ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap">
    <h2 class="nhy-h2 nhy-center">Nézze, hogyan pezseg</h2>
    <p class="nhy-fizz-text">Nézze az elektrolízis közben keletkező erős buborékokat — ez a tiszta hidrogénes dúsítás a legjobb formájában. A víz közben minden ciklus után tiszta és frissítő marad.</p>
    <div class="nhy-fizz">
...
<!-- ============ 3) Antioxidáns erő, kevesebb gyulladás ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Antioxidáns erő, kevesebb gyulladás</h2>
      <p>A hidrogénes vizet erős antioxidáns és gyulladáscsökkentő hatásáról ismerik, amelyet tudományos kutatások több mint 150 állapot esetén hoznak összefüggésbe kedvező hatásokkal.</p>
      <p>Klinikai vizsgálatok azt is kimutatták, hogy három üveg hidrogénes víz elfogyasztása több száz darab gyümölcs és zöldség antioxidáns hatásához hasonló eredményt adhat.</p>
      <p class="nhy-note">A hidrogénes víz a napi folyadékpótlás kiegészítője, nem az orvosi kezelés helyettesítője.</p>
    </div>
...
<section class="nhy-sec">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">Valódi felhasználói történetek</h2>
  </div>
  <div class="nhy-wrap nhy-row2">
    ...
    <div class="nhy-copy">
      <ul class="nhy-stories">
        <li><strong>Regenerálódás több energiával</strong><span>„Nakon svakog treninga osjećam manje umora u mišićima. HydraH₂ mi je oporavak učinio jednostavnim."</span></li>
        <li><strong>Látható hidratálás</strong><span>„Koža mi je punija i bolje hidrirana. Savršeno za svakodnevnu rutinu."</span></li>
        <li><strong>Praktikus és tiszta</strong><span>„Nema okusa plastike, punjenje preko USB-a je jednostavno. Moja svakodnevna boca."</span></li>
      </ul>
    </div>
  </div>
</section>

<!-- ============ 5) A hidrogénes víz előnyei ============ -->
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-center">
    <h2 class="nhy-h2">A hidrogénes víz előnyei</h2>
  </div>
  <div class="nhy-wrap">
    <div class="nhy-perks">
      <div class="nhy-perk"><strong>Jobb hidratálás</strong><span>A vizet nagy koncentrációjú hidrogénnel dúsítja az optimális hidratálásért.</span></div>
      <div class="nhy-perk"><strong>Újratölthető akkumulátor</strong><span>A 60 percnél rövidebb USB-töltés egész napra készen tartja a palackot.</span></div>
      <div class="nhy-perk"><strong>Tartós szűrő</strong><span>A beépített szűrőt nem kell cserélni — időt és pénzt takarít meg.</span></div>
      <div class="nhy-perk"><strong>Gyors ciklusok</strong><span>Válasszon 3 vagy 10 perces ciklust a személyre szabott hidrogénadagért.</span></div>
    </div>
  </div>
</section>

<!-- ============ 6) Fejlett hidrogén-előállítás ============ -->
<section class="nhy-sec">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-media"><?php echo $nh_img('hyd-04-kako-radi.webp','PEM i SPE elektroliza — proizvodnja vodika'); ?></div>
    <div class="nhy-copy">
      <h2 class="nhy-h2">Fejlett hidrogén-előállítás</h2>
      <p>A csúcsminőségű <strong>PEM és SPE elektrolízissel</strong> a NORIKS HYD akár <strong>3 000 ppb</strong> molekuláris hidrogént állít elő a vízben. Az üvegpalack rozsdamentes acél alappal biztosítja, hogy a víz soha ne érintkezzen műanyaggal, a generátor tartós szűrője pedig feleslegessé teszi a karbantartást. Az automatikus légtelenítés eltávolítja a maradék gázokat a tiszta, biztonságos ivásért.</p>
      <ul class="nhy-check">
        <li>Platinabevonatú titánelektródák</li>
        <li>99,99 %-ban tiszta hidrogén, a melléktermékek a szellőzőn távoznak</li>
        <li>Bármilyen ivóvízzel működik, a desztillálttal is</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="nhy-sec nhy-alt">
  <div class="nhy-wrap nhy-row2">
    <div class="nhy-copy">
      <h2 class="nhy-h2">Készen áll, hogy magasabb szintre emelje a hidratálást?</h2>
      <p>Csatlakozzon azokhoz az ezrekhez, akik hidrogénben gazdag vízzel fejlesztették wellness-rutinjukat. Érezze az energialöketet, a jobb regenerálódást és a látható hidratálást.</p>
      <a class="nhy-cta" href="#bundle-selector">NORIKS HYD rendelése</a>
    </div>
