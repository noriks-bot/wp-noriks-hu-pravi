...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  <div class="size-chart-titlebar">
    <h2 id="custom-size-chart-title">Mérettáblázat</h2>
  ...
  <div  style="<?php if ( has_term( array( 'orto-starter', 'orto-majica-bokserica' ), 'product_cat', get_the_ID() ) ): ?>  display: block; <?php endif; ?>"
      ...
      <div class="noriks-bx">
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Méret</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Boxer méretei: a, b, c, d" loading="lazy">
        <p class="noriks-bx-note"><strong>Válaszd ugyanazt a méretet, amit általában hordasz.</strong><br>A méretek centiméterben. A méretek &plusmn;1&ndash;2 cm-t eltérhetnek. Ha két méret között vagy, válaszd a kisebbet &mdash; az anyag rugalmas.</p>
      </div>

      
      
       
      <?php elseif ( has_term( array( 'zoknik', 'zimske-carape', 'kaltses', 'socks' ), 'product_cat', get_the_ID() ) ): ?>
    ...
    style="margin-top: 70px;margin-bottom: 70px;"
      ...
      src="https://noriks.com/hu/wp-content/uploads/2026/02/Nogavice_tabela_velikosti_hu.png"
      alt="Size Guide">
    ...
    style="margin-top: 35px;margin-bottom: 0px;"
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Hogyan mérje meg a csípőjét</p>
        <p style="margin:0 0 14px;line-height:1.6;font-size:14px;color:#333;">Tekerje a mérőszalagot a csípő legszélesebb pontja köré (a fenéken át), megfeszítés nélkül, majd jegyezze fel a méretet centiméterben.</p>
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Méret</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Csípő (cm)</th>
          </tr></thead>
          <tbody>
          <?php foreach ( array(array('S','76 cm-ig','30"-ig'),array('M','77 – 85 cm','30 – 33"'),array('L','86 – 94 cm','34 – 37"'),array('XL','95 – 102 cm','37 – 40"'),array('2XL','103 – 114 cm','41 – 45"'),array('3XL','115 – 121 cm','45 – 48"'),array('4XL','122 – 129 cm','48 – 51"'),array('5XL','130 – 137 cm','51 – 54"'),array('6XL','138 – 145 cm','54 – 57"'),array('7XL','146 – 153 cm','57 – 60"'),array('8XL','154 cm és felette','61" és felette') ) as $i=>$r): ?>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Két méret között van?</strong> Az optimális kényelem és a maximális nedvszívás érdekében a nagyobb méretet ajánljuk.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <table style="width:100%;border-collapse:collapse;font-size:16px;">
          <thead><tr style="background:#111;color:#fff;">
            <th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Méret</th><th style="padding:11px 12px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Megfelelő testsúly</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Válassza ki a méretét a testsúlya alapján. Két méret között van? Erősebb kompresszióhoz a kisebb méretet válassza.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
          ...
          <table class="noriks-sc">
            <thead>
              <tr>
                ...
                <th class="noriks-sc-empty" style="width:80px;">Méret</th>
                <th>59-68 kg</th>
                <th>69-77 kg</th>
                <th>78-84 kg</th>
                <th>84-95 kg</th>
            ...
            <tbody>
              <tr>
                <th class="noriks-sc-vis-label" rowspan="11">Magasság (cm)</th>
                <th>168 cm</th>
        ...
        <div class="noriks-sc-steps">
          <h3>Hogyan találd meg a méretedet</h3>
          <div class="noriks-sc-steps-grid">
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">1</span>
              <span>Keresd meg a <strong>magasságodat</strong> a bal oszlopban.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">2</span>
              <span>Keresd meg a <strong>súlyodat</strong> a felső sorban.</span>
            </div>
            <div class="noriks-sc-step">
              <span class="noriks-sc-num">3</span>
              <span>A mező, ahol metszik egymást &mdash; az a te méreted.</span>
            </div>
          </div>
        </div>

        <div class="noriks-sc-pro">
          <span class="noriks-sc-pro-tag">PROFI TIPP</span>
          <span>Ha két méret között vagy és <strong>lazább szabást</strong> szeretnél, válaszd a nagyobbat. <strong>Testhezállóbb megjelenéshez</strong> válaszd a kisebbet.</span>
        </div>

        <div class="noriks-sc-guarantee">
          <span class="noriks-sc-check">&#10003;</span>
          <span>Nem vagy biztos benne? Ingyenes méretcsere 90 napon belül.</span>
        </div>
      </div>
