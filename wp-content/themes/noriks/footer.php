  ...
  <div class="footer-row">
    ...
    <div class="footer-col">
      <div class="link-section">
        ...
        <a style="margin-top:-10px;" href="https://noriks.com/hu">
        <span style="color: white; font-family: 'Roboto', sans-serif; font-size: 33px; font-weight: bold; letter-spacing: 1.75px;">NORIKS</span>
       
      </a>
        
              <p class="footer-brand-dec" style="padding-right: 100px; font-size:12px;" >A NORIKS azért jött létre, hogy megoldjon egy egyszerű, de gyakran figyelmen kívül hagyott problémát: a legtöbb férfinak nincs olyan ruhája, ami igazán jól áll. A rövid, szűk és rosszul szabott alapdarabok okozta csalódásból kiindulva a NORIKS időtálló ruhákat tervez erősebb testalkatúaknak – hosszabb, kényelmesebb és ott gondosan kidolgozott, ahol a leginkább szükséges.
</p>
      </div>
    </div>
