...
.color-piros { background: #ba212f; }
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter', 'orto-majice', 'orto-polok', 'orto-bokserice', 'orto-boxeralsok', 'orto-polo-boxeralso', 'orto-kompresijske-carape', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers', 'orto-majica-darila', 'orto-leak-boxers', 'orto-kompresijske-majice' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
