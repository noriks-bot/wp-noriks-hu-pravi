...
function gck_split_attrs_color_size( array $custom_attrs ) : array {
    ...
    foreach ( $custom_attrs as $key => $attr ) {
        ...
        $is_color = ( strpos($hay, 'szin') !== false || strpos($hay, 'color') !== false || strpos($hay, 'colour') !== false );
        $is_size  = ( strpos($hay, 'meret')  !== false || strpos($hay, 'veli') !== false || strpos($hay, 'size') !== false );
...
function gck_render_bundle_selector() {
    ...
    if (
        ...
        || ( stripos( (string) $product->get_slug(), 'kompresz' ) !== false )
    ) {
        $gck_garment = 'carapa';
    }
...
.color-piros { background: #ba212f; }
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-kezdocsomag', 'orto-polok', 'orto-boxeralsok', 'orto-kompresziós-zokni', 'orto-kompreszios-zokni', 'kompreszios-zokni', 'kompresziós-zokni', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers', 'orto-majica-darila' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <div class="gck-benefits-box">
        <?php if ( ! has_term( array( 'orto-kompresziós-zokni', 'orto-kompreszios-zokni', 'kompreszios-zokni', 'kompresziós-zokni', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers', 'orto-noriks-hers' ), 'product_cat', $product_id ) ) : // hide benefits list for compression socks + back belt + bunion + fisiorest ?>
        ...
        <?php if ( ! $show_countdown && ! $gck_no_attrs && ! $gck_single_size && ! has_term( array( 'orto-kompresziós-zokni', 'orto-kompreszios-zokni', 'kompreszios-zokni', 'kompresziós-zokni' ), 'product_cat', $product_id ) ) : ?>
